...
<dsl-rim:namespaceMappings xmlns:dsl-rim="http://www.decisionsoft.com/rim" xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse">
    ...
    <dsl-rim:namespaceMapping prefix="eps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/17-18/1"/>
...
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RecoverableAmountsYTD/eps:TaxMonth" mode="M13" priority="4000">
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('1' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-03-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-05-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('2' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-04-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-06-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('3' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-05-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-07-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('4' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-06-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-08-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('5' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-07-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-09-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('6' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-08-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-10-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('7' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-09-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-11-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('8' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-10-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, '-12-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('9' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-11-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, '-01-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('10' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018 - 1, '-12-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, '-02-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('11' = (.))               or             (               (round(date:seconds(normalize-space(concat(2018, '-01-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, '-03-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('12' = (.))               or             (round(date:seconds(normalize-space(concat(2018, '-02-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))"/>
      <axsl:otherwise>
...
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RelatedTaxYear" mode="M15" priority="4000">
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="substring(string(2018 - 1), 3, 2) = substring(., 1, 2)           and             substring(2018, 3, 2) = substring(., 4, 2)"/>
      <axsl:otherwise>
        ...
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>Must be the appropriate tax year for the schema year. I.E. 17-18 for RTI-2018</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p62-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:FinalSubmission" mode="M18" priority="4000">
...
<!--PATTERN p51-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary" mode="M19" priority="4000">
...
<axsl:choose>
      ...
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="eps:NoPaymentForPeriod or eps:PeriodOfInactivity or eps:EmpAllceInd or eps:RecoverableAmountsYTD or eps:ApprenticeshipLevy or eps:Account or eps:FinalSubmission"/>
      <axsl:otherwise>
        ...
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>At least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [APPRENTICESHIPLEVY], [ACCOUNTINFORMATION] or [FINALSUBMISSION] must be submitted.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
