...
<dsl-rim:namespaceMappings xmlns:dsl-rim="http://www.decisionsoft.com/rim" xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse">
    ...
    <dsl-rim:namespaceMapping prefix="fps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/17-18/1"/>
...
<!--PATTERN p33-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:Benefits/fps:Car/fps:AvailTo" mode="M21" priority="4000">
...
<!--PATTERN p34-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:Benefits/fps:Car/fps:FreeFuel/fps:Withdrawn" mode="M22" priority="4000">
...
<!--PATTERN p35-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:SMPYTD" mode="M23" priority="4000">
...
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:FlexibleDrawdown" mode="M25" priority="4000">
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="fps:FlexiblyAccessingPensionRights or fps:PensionDeathBenefit"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7935</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [FLEXIBLYACCESSINGPENSIONRIGHTS] or [PENSIONDEATHBENEFIT] must be present. Please check.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [FLEXIBLEDRAWDOWN] is present the following should be true: [FLEXIBLYACCESSINGPENSIONRIGHTS] is present or [PENSIONDEATHBENEFIT] is present</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<axsl:choose>
      ...
      <axsl:otherwise>
        ...
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [TAXABLEPAYMENT] or [NONTAXABLEPAYMENT] must be present. Please check.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [FLEXIBLEDRAWDOWN] is present, at least one of [TAXABLEPAYMENT] or [NONTAXABLEPAYMENT] should be present</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<axsl:choose>
      ...
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not ( fps:Starter )               or                 fps:Starter/fps:StartDate               or                 fps:Starter/fps:StartDec               or                 fps:Starter/fps:StudentLoan               or                 fps:Starter/fps:Seconded               or                 fps:Starter/fps:OccPension               or                 fps:Starter/fps:StatePension"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7934</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">If [STARTERINFORMATION] is present then an entry in [STARTDATE], [STARTINGDECLARATION], [HASSTUDENTLOAN], [INDIVIDUALSECONDEDTOWORKINUK], [PENSIONSTART] or [PENSIONSTART] should be present. Please check.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [STARTERINFORMATION] is present then [STARTDATE], [STARTINGDECLARATION], [HASSTUDENTLOAN], [INDIVIDUALSECONDEDTOWORKINUK], [PENSIONSTART] or [PENSIONSTART] should be present</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
