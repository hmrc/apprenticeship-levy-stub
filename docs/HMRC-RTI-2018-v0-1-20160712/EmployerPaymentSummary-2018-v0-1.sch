...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="exslt">
  ...
  <sch:ns prefix="eps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/17-18/1"/>
    <sch:pattern id="p50">
    ...
    <sch:pattern id="p60">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RecoverableAmountsYTD/eps:TaxMonth">
        <sch:assert test="not(&apos;1&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-03-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-05-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;2&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-04-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-06-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;3&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-05-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-07-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;4&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-06-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-08-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;5&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-07-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-09-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;6&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-08-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-10-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;7&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-09-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-11-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;8&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-10-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018 - 1, &apos;-12-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;9&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-11-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, &apos;-01-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;10&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018 - 1, &apos;-12-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, &apos;-02-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;11&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2018, &apos;-01-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2018, &apos;-03-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;12&apos; = (.))
              or
            (round(date:seconds(normalize-space(concat(2018, &apos;-02-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))" id="a_TAXMONTH.12" diagnostics="errorCode.TAXMONTH.12 transactional.TAXMONTH.12 transactional.en.TAXMONTH.12 ">A [TAXMONTH] equal to 12 is only valid if the submission is made on or after 6 February of [RELATEDTAXYEAR].</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p59">
    ...
    <sch:pattern id="p61">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RelatedTaxYear">
        <sch:assert test="substring(string(2018 - 1), 3, 2) = substring(., 1, 2)
          and
            substring(2018, 3, 2) = substring(., 4, 2)" id="a_RELATEDTAXYEAR.0" diagnostics="errorCode.RELATEDTAXYEAR.0 transactional.RELATEDTAXYEAR.0 transactional.en.RELATEDTAXYEAR.0 ">Must be the appropriate tax year for the schema year. I.E. 17-18 for RTI-2018</sch:assert>
    ...
    <sch:pattern id="p51">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary">
        ...
        <sch:assert test="eps:NoPaymentForPeriod or eps:PeriodOfInactivity or eps:EmpAllceInd or eps:RecoverableAmountsYTD or eps:ApprenticeshipLevy or eps:Account or eps:FinalSubmission" id="a_EPS.0" diagnostics="errorCode.EPS.0 transactional.EPS.0 transactional.en.EPS.0 ">At least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [APPRENTICESHIPLEVY], [ACCOUNTINFORMATION] or [FINALSUBMISSION] must be submitted.</sch:assert>
      </sch:rule>
    </sch:pattern>
  <sch:diagnostics>
    ...
    <sch:diagnostic xml:lang="en" id="transactional.en.EPS.0">On an Employer Payment Submission there must be an entry in at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [APPRENTICESHIPLEVY], [ACCOUNTINFORMATION] or [FINALSUBMISSION]. Please check.</sch:diagnostic>
