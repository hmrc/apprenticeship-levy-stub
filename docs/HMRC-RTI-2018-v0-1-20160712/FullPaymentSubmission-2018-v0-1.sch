...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="exslt">
  ...
  <sch:ns prefix="fps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/17-18/1"/>
    <sch:pattern id="p14">
    ...
    <sch:pattern id="p26">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment">
        ...
        <sch:assert test="not ( fps:Starter )
              ...
              or
                fps:Starter/fps:StatePension" id="a_STARTERINFORMATION.FPS.0" diagnostics="errorCode.STARTERINFORMATION.FPS.0 transactional.STARTERINFORMATION.FPS.0 transactional.en.STARTERINFORMATION.FPS.0 ">If [STARTERINFORMATION] is present then [STARTDATE], [STARTINGDECLARATION], [HASSTUDENTLOAN], [INDIVIDUALSECONDEDTOWORKINUK], [PENSIONSTART] or [PENSIONSTART] should be present</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p21">
  ...
  <sch:diagnostics>
    ...
    <sch:diagnostic id="transactional.STARTERINFORMATION.FPS.0">If [STARTERINFORMATION] is present then an entry in [STARTDATE], [STARTINGDECLARATION], [HASSTUDENTLOAN], [INDIVIDUALSECONDEDTOWORKINUK], [PENSIONSTART] or [PENSIONSTART] should be present. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.STARTERINFORMATION.FPS.0">If [STARTERINFORMATION] is present then an entry in [STARTDATE], [STARTINGDECLARATION], [HASSTUDENTLOAN], [INDIVIDUALSECONDEDTOWORKINUK], [PENSIONSTART] or [PENSIONSTART] should be present. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FLEXIBLEDRAWDOWN.0">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [FLEXIBLYACCESSINGPENSIONRIGHTS] or [PENSIONDEATHBENEFIT] must be present. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FLEXIBLEDRAWDOWN.0">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [FLEXIBLYACCESSINGPENSIONRIGHTS] or [PENSIONDEATHBENEFIT] must be present. Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.FLEXIBLEDRAWDOWN.1">7936</sch:diagnostic>
    <sch:diagnostic id="transactional.FLEXIBLEDRAWDOWN.1">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [TAXABLEPAYMENT] or [NONTAXABLEPAYMENT] must be present. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FLEXIBLEDRAWDOWN.1">If [FLEXIBLEDRAWDOWN] is present, an entry in at least one of [TAXABLEPAYMENT] or [NONTAXABLEPAYMENT] must be present. Please check.</sch:diagnostic>
